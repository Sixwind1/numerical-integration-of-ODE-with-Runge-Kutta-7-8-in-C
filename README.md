...
The example problem was the final objective of this assignment. It aims to find the numerical solution of the non-planar periodic orbit, called the 'Halo orbit'.
...
To run the example program, you should compile the following c-files:
